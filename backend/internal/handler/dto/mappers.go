...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	...
	// For visible balance adjustments and subscription purchases, include notes
	// so users can see the reason or purchased plan name.
	if (rc.Type == "admin_balance" || rc.Type == "admin_concurrency" || rc.Type == service.RedeemTypeSubscriptionPurchase) && rc.Notes != "" {
		out.Notes = &rc.Notes
	}
