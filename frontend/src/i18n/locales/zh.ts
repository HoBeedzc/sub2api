export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        invoiceFeeRate: '开票费率',
        invoiceFeeRateHint: '用户勾选开票时额外叠加的费率，0 表示不开启开票加收',
        invoiceFeePreview: '开票时总费率：{fee}%',
        orderTimeout: '订单超时时间',
  ...
  payment: {
    ...
    currentBalance: '当前余额',
    balancePurchase: '账户余额',
    balanceAfterPurchase: '购买后余额',
    insufficientBalanceForPlan: '余额不足，当前 {balance}，套餐价格 {price}',
    purchaseWithBalance: '余额购买',
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: '余额不足，请先充值后再购买订阅',
      ...
      REFUND_FAILED: '退款失败',
      OFFLINE_PAYMENT_ONLY: '只能确认线下收款订单',
