export default {
  ...
  payment: {
    ...
    offline: {
      title: '等待管理员确认收款',
      hint: '订单已创建，请按站点提供的线下方式完成转账或联系管理员。管理员确认后会自动到账。',
      waiting: '待线下确认',
      pollingHint: '本页面会自动刷新订单状态，确认后会显示支付成功。',
      waitingPayment: '等待线下收款确认...',
    },
    orders: {
      title: '我的订单',
      empty: '暂无订单',
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      OFFLINE_PAYMENT_ONLY: '仅线下收款订单可以确认收款',
      OFFLINE_PAYMENT_ALREADY_PAID: '该线下收款订单已支付',
      PAYMENT_AMOUNT_MISMATCH: '确认金额与订单金额不一致',
    },
    ...
    admin: {
      ...
      retry: '重试',
      retrySuccess: '重试成功',
      confirmOffline: '确认线下收款',
      confirmOfflineSuccess: '线下收款已确认',
      confirmOfflineHint: '确认后订单会标记为已支付，并立即执行充值或订阅开通。',
      offlineReference: '收款凭证号',
      offlineReferencePlaceholder: '如银行流水号、微信/支付宝转账单号（可选）',
      offlineNote: '备注',
      offlineNotePlaceholder: '记录收款账号、操作人或其他说明（可选）',
      approveRefund: '批准退款',
      retryRefund: '重试退款',
