export default {
  ...
  nav: {
    ...
    affiliateManagement: 'Invitations',
  ...
  auth: {
    ...
    invitationCodePlaceholder: 'Enter an admin or existing user invitation code',
    invitationCodeRequired: 'Invitation code is required',
    invitationCodeValid: 'Invitation code is valid',
    invitationCodeInvalid: 'Invalid invitation code, or the one-time invitation has already been used',
