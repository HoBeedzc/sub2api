export default {
  ...
  admin: {
    ...
    users: {
      ...
      typeSubPurchase: 'Balance (Subscription Purchase)',
    ...
    settings: {
      ...
      payment: {
        ...
        invoiceFeeRate: 'Invoice Fee Rate',
        invoiceFeeRateHint: 'Additional fee rate applied only when the user requests an invoice; 0 disables the extra charge',
        invoiceFeePreview: 'Total fee rate with invoice: {fee}%',
        ...
        providerOffline: 'Offline Collection',
  ...
  payment: {
    ...
    offline: {
      ...
      hint: 'Your order has been created. Complete the offline transfer or contact an administrator. It will be credited after confirmation.',
      waiting: 'Awaiting offline confirmation',
      pollingHint: 'This page refreshes the order status automatically and shows success once confirmed.',
      waitingPayment: 'Waiting for offline collection confirmation...',
    },
    orders: {
      title: 'My Orders',
      empty: 'No orders yet',
    ...
    currentBalance: 'Current Balance',
    balancePurchase: 'Account Balance',
    balanceAfterPurchase: 'Balance After Purchase',
    insufficientBalanceForPlan: 'Insufficient balance. Current {balance}, plan price {price}.',
    purchaseWithBalance: 'Buy with Balance',
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: 'Insufficient balance. Please top up before buying a subscription.',
      ...
      REFUND_FAILED: 'Refund failed.',
      OFFLINE_PAYMENT_ONLY: 'Only offline collection orders can be confirmed.',
      OFFLINE_PAYMENT_ALREADY_PAID: 'This offline collection order has already been paid.',
      PAYMENT_AMOUNT_MISMATCH: 'Confirmed amount does not match the order amount.',
    },
    ...
    admin: {
      ...
      confirmOfflineSuccess: 'Offline collection confirmed',
      confirmOfflineHint: 'After confirmation, the order is marked as paid and fulfillment runs immediately.',
      offlineReference: 'Collection Reference',
      offlineReferencePlaceholder: 'Bank reference, transfer ID, or receipt number (optional)',
      offlineNote: 'Note',
      offlineNotePlaceholder: 'Record the collection account, operator, or extra details (optional)',
